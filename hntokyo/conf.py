...
BLOG_AUTHOR = "Paul Oswald"  # (translatable)
BLOG_TITLE = "HN Tokyo"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hntokyo.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hntokyo.io/"
BLOG_EMAIL = "pauloswald@gmail.com"
BLOG_DESCRIPTION = "Tokyo's longest running startup community"  # (translatable)
